const model = {
    ...
    admin: {
        ...
        calendarNotes: [
            { id: 1, orders: [0], task: 'Vask gulvet', date: '25.2.2020', isComplete: false, },
            { id: 2, orders: [0], task: 'Bestill varer fra ASKO', date: '26.2.2020', isComplete: false, },
            { id: 3, orders: [0], task: 'Rydd i kjøleskapet', date: '27.2.2020', isComplete: false, },
...

        {
            ...
            idNR: '5846512',
            addon: '',
            note: 'Vil ha kaker fra måånen',
            firm: 'ting og tang',
            contact: 'Frank Sinatra',
            phoneNr: '1234569987',
            email: 'Frank-Sinatra@betalerikkeskatt.no',
            adress: 'norgesgate 3',
            invoiceNR: '123123123123',
            delivery: false,
